            ...
            <div class="card card-block">
                <div class="card-header d-flex justify-content-between bg-primary">
                    ...
                    <div class="invoice-btn d-flex">
                        <form action="{{ route('pos.printInvoice') }}" target="_blank" method="post">
                            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <img src="{{ asset('assets/images/hdz.png') }}" class="logo-invoice img-fluid mb-3">
                    ...
                    <div class="row mt-4 mb-3">
                        <div class="offset-lg-8 col-lg-4">
                            <div class="or-detail rounded">
                                <div class="p-3">
                                    <h5 class="mb-3">Detalles de su compra</h5>
                                    <div class="mb-2">
                                        <h6>Sub Total</h6>
                                        <p>${{ Cart::subtotal() }}</p>
                                    </div>
