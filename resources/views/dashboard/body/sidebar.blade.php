...
<div class="iq-sidebar sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        <a href="{{ route('dashboard') }}" class="header-logo">
            <img src="{{ asset('assets/images/logo/hdz.png') }}" width="300" height="auto" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3"></h5>
        </a>
    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ Request::is('pos*') ? 'active' : '' }}">
                    <a href="{{ route('salidas.create') }}" class="svg-icon">
                        <i class="fa-solid fa-cart-shopping"></i>
                        <span class="ml-3">Salidas y adelantos</span>
                    </a>
                </li>
                @endif
