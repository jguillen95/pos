                        ...
                        <div class="invoice-top">
                            <div class="row">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="logo">
                                        <img class="logo" src="{{ asset('assets/images/logo/hdz.png') }}" alt="logo">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="invoice">
                        ...
                        <div class="invoice-info">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    <h4 class="inv-title-1">JoSolutions POS</h4>
                                    <p class="inv-from-1">admin@josolution.mx</p>
                                    <p class="inv-from-2">Morelia, Mich</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 mb-50">
