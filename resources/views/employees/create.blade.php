            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Agregar empleados</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="phone">Teléfono de empleado <span class="text-danger">*</span></label>
                            ...
                            {{-- <div class="form-group col-md-6">
                                <label for="city">Ciudad del empleo <span class="text-danger">*</span></label>
