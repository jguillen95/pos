...
use App\Http\Controllers\Dashboard\SalidaController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard/resume', [DashboardController::class, 'search'])->name('dashboard.search');
    Route::get('/dashboard/corte', [DashboardController::class, 'corte'])->name('dashboard.corte');
